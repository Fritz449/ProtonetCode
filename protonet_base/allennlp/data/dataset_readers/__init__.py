...
from allennlp.data.dataset_readers.snips import SnipsDatasetReader
from allennlp.data.dataset_readers.snips_pnet import PnetSnipsDatasetReader
from allennlp.data.dataset_readers.onto_pnet import PnetOntoDatasetReader
from allennlp.data.dataset_readers.onto_test import TestOntoDatasetReader
